...
(function (a) { 
    ...
    a = a ? a._modules : {};
    g(a, "Extensions/FullScreen.js", [a["Core/Chart/Chart.js"], a["Core/Globals.js"], a["Core/Renderer/HTML/AST.js"], a["Core/Utilities.js"]], function (a, e, r, t) {
        var l = t.addEvent;
        t = (function () {
            function a(d) {
                this.chart = d;
                ...
                this.browserProps ||
                    ("function" === typeof d.requestFullscreen
                        ...
                        ? (this.browserProps = { fullscreenChange: "webkitfullscreenchange", requestFullscreen: "webkitRequestFullScreen", exitFullscreen: "webkitExitFullscreen" })
            ...
            a.prototype.setButtonText = function () {
                ...
                b &&
                    ...
                    r.setElementHTML(a, this.isOpen ? d.exitFullscreen : b.menuItemDefinitions.viewFullscreen.text || d.viewFullscreen);
            };
    ...
    g(a, "Extensions/Exporting/ExportingDefaults.js", [a["Core/Globals.js"]], function (a) {
        return {
            ...
            navigation: {
                ...
                menuItemStyle: { padding: "0.5em 1em", color: "#333333", background: "none", fontSize: a.isTouchDevice ? "14px" : "11px", transition: "background 250ms, color 250ms" },
    ...
    g(a, "Core/HttpUtilities.js", [a["Core/Globals.js"], a["Core/Utilities.js"]], function (a, e) {
        var l = a.doc,
            ...
            J = {
                ajax: function (a) {
                    var b = k(!0, { url: !1, type: "get", dataType: "json", success: !1, error: !1, data: !1, headers: {} }, a);
                    a = { json: "application/json", xml: "application/xml", text: "text/plain", octet: "application/octet-stream" };
                ...
                post: function (a, e, r) {
                    var b = g("form", k({ method: "post", action: a, enctype: "multipart/form-data" }, r), { display: "none" }, l.body);
                    d(e, function (a, d) {
            ...
            (function (e) {
                function t(a) {
                    ...
                    if (!1 !== b.enabled && b.theme) {
                        ...
                        b.text && b.symbol ? (f.paddingLeft = w(f.paddingLeft, 30)) : b.text || F(f, { width: b.width, height: b.height, padding: 0 });
                        ...
                        var p = d
                            ...
                            .attr({ title: w(c.options.lang[b._titleKey || b.titleKey], "") });
                        p.menuClassName = a.menuClassName || "highcharts-menu-" + c.btnCount++;
                        if (b.symbol) {
                            var g = d
                                .symbol(b.symbol, b.symbolX - n / 2, b.symbolY - n / 2, n, n, { width: n, height: n })
                                .addClass("highcharts-button-symbol")
                                .attr({ zIndex: 1 })
                                .add(p);
                            c.styledMode || g.attr({ stroke: b.symbolStroke, fill: b.symbolFill, "stroke-width": b.symbolStrokeWidth || 1 });
                        }
                        p.add(c.exportingGroup).align(F(b, { width: p.width, x: w(b.x, c.buttonOffset) }), !0, "spacingBox");
                ...
                function U(c, d, e, y, g, B, n) {
                    var f = this,
                        ...
                        h = f[p];
                    if (!h) {
                        f.exportContextMenu = f[p] = h = E("div", { className: c }, { position: "absolute", zIndex: 1e3, padding: v + "px", pointerEvents: "auto" }, f.fixedDiv || f.container);
                        var m = E("ul", { className: "highcharts-menu" }, { listStyle: "none", margin: 0, padding: 0 }, h);
                        f.styledMode || q(m, F({ MozBoxShadow: "3px 3px 10px #888", WebkitBoxShadow: "3px 3px 10px #888", boxShadow: "3px 3px 10px #888" }, u.menuStyle));
                        h.hideMenu = function () {
                            q(h, { display: "none" });
                            n && n.setState(0);
                            f.openMenu = !1;
                        ...
                        d.forEach(function (c) {
                            ...
                            if (Q(c, !0)) {
                                ...
                                c.separator
                                    ...
                                    : ("viewData" === c.textKey && f.isDataTableVisible && (c.textKey = "hideData"),
                                      (b = E(
                                          "li",
                                          {
                ...
                function W(a, b) {
                    ...
                    J.post(a.url, { filename: a.filename ? a.filename.replace(/\//g, "-") : this.getFilename(), type: a.type, width: a.width || 0, scale: a.scale, svg: b }, a.formAttributes);
                }
                function X() {
                ...
                function Z(a) {
                    ...
                    var d = E("div", null, { position: "absolute", top: "-9999em", width: this.chartWidth + "px", height: this.chartHeight + "px" }, l.body),
                    ...
                    F(c.chart, { animation: !1, renderTo: d, forExport: !0, renderer: "SVGRenderer", width: e, height: g });
                    c.exporting.enabled = !1;
                    delete c.data;
                    c.series = [];
                    this.series.forEach(function (a) {
                        b = m(a.userOptions, { animation: !1, enableMouseTracking: !1, showCheckbox: !1, visible: a.visible });
                ...
                function aa(a, b) {
                    ...
                    return this.getSVG(m({ chart: { borderRadius: 0 } }, c.chartOptions, b, { exporting: { sourceWidth: (a && a.sourceWidth) || c.sourceWidth, sourceHeight: (a && a.sourceHeight) || c.sourceHeight } }));
                }
                function M(a) {
                ...
                function ja(a, b) {
                    ...
                    b &&
                        ...
                        d &&
                        ((d =
                            '<foreignObject x="0" y="0" width="' + b.chart.width + '" height="' + b.chart.height + '"><body xmlns="http://www.w3.org/1999/xhtml">' + d.replace(/(<(?:img|br).*?(?=>))>/g, "$1 />") + "</body></foreignObject>"),
