...
for (i = 0; i < dropdown.length; i++) {
  dropdown[i].addEventListener("click", function() {
    ...
    if (dropdownContent.style.display === "block") {
    	...
    	jQuery(this).find('.fa-caret-up').css('display','none');
    	jQuery(this).find('.fa-caret-down').css('display','block');
    } else {
      dropdownContent.style.display = "block";
      	jQuery(this).find('.fa-caret-up').css('display','block');
    	jQuery(this).find('.fa-caret-down').css('display','none');
    }
  });
}