...
<section class="col-lg-8 pt-lg-4 pb-4 mb-3">
  <div class="pt-2 px-4 ps-lg-0 pe-xl-5">
    ...
    <!-- Product-->
    <div class="d-block d-sm-flex align-items-center py-4 border-bottom"><a class="d-block mb-3 mb-sm-0 me-sm-4 ms-sm-0 mx-auto" href="marketplace-single.html" style="width: 12.5rem;"><img class="rounded-3" src="../img/marketplace/products/th02.jpg" alt="Product"></a>
      <div class="text-center text-sm-start">
        <h3 class="h6 product-title mb-2"><a href="marketplace-single.html">UI Isometric Devices Pack (PSD)</a></h3>
        <div class="text-accent fs-sm mb-1">Extended license</div>
        <div class="form-check d-table text-start mx-auto mx-sm-0">
          <input class="form-check-input" type="checkbox" id="update-info-2" checked>
          <label class="form-check-label fs-ms" for="update-info-2">Notify me when this product is updated</label>
        </div>
        <div class="d-flex align-items-center justify-content-center justify-content-sm-start pt-2">
          <div class="my-2">
            <button class="btn btn-primary btn-sm me-3" type="button"><i class="ci-download me-1"></i>Download</button>
            ...
            <div class="fs-xs">You rated this product</div></a>
        </div>
      </div>
    </div>
    <!-- Product-->
    <div class="d-block d-sm-flex align-items-center py-4 border-bottom"><a class="d-block mb-3 mb-sm-0 me-sm-4 ms-sm-0 mx-auto" href="marketplace-single.html" style="width: 12.5rem;"><img class="rounded-3" src="../img/marketplace/products/th03.jpg" alt="Product"></a>
      <div class="text-center text-sm-start">
        <h3 class="h6 product-title mb-2"><a href="marketplace-single.html">Cartzilla - Multipurpose E-Commerce Template</a></h3>
        <div class="text-accent fs-sm mb-1">Standard license</div>
        <div class="form-check d-table text-start mx-auto mx-sm-0">
          <input class="form-check-input" type="checkbox" id="update-info-3" checked>
          <label class="form-check-label fs-ms" for="update-info-3">Notify me when this product is updated</label>
        </div>
        <div class="d-flex align-items-center justify-content-center justify-content-sm-start pt-2">
          <div class="my-2">
            <button class="btn btn-primary btn-sm me-3" type="button"><i class="ci-download me-1"></i>Download</button>
    ...
    <!-- Product-->
    <div class="d-block d-sm-flex align-items-center py-4 border-bottom"><a class="d-block mb-3 mb-sm-0 me-sm-4 ms-sm-0 mx-auto" href="marketplace-single.html" style="width: 12.5rem;"><img class="rounded-3" src="../img/marketplace/products/th04.jpg" alt="Product"></a>
      <div class="text-center text-sm-start">
        <h3 class="h6 product-title mb-2"><a href="marketplace-single.html">Hardcover Book Catalog Mockup (PSD)</a></h3>
        <div class="text-accent fs-sm mb-1">Standard license</div>
        <div class="form-check d-table text-start mx-auto mx-sm-0">
          <input class="form-check-input" type="checkbox" id="update-info-4">
          <label class="form-check-label fs-ms" for="update-info-4">Notify me when this product is updated</label>
        </div>
        <div class="d-flex align-items-center justify-content-center justify-content-sm-start pt-2">
          <div class="my-2">
            <button class="btn btn-primary btn-sm me-3" type="button"><i class="ci-download me-1"></i>Download</button>
    ...
    <!-- Product-->
    <div class="d-block d-sm-flex align-items-center py-4 border-bottom"><a class="d-block mb-3 mb-sm-0 me-sm-4 ms-sm-0 mx-auto" href="marketplace-single.html" style="width: 12.5rem;"><img class="rounded-3" src="../img/marketplace/products/th05.jpg" alt="Product"></a>
      <div class="text-center text-sm-start">
        <h3 class="h6 product-title mb-2"><a href="marketplace-single.html">Photo of Business Meeting</a></h3>
        <div class="text-accent fs-sm mb-1">Standard license</div>
        <div class="form-check d-table text-start mx-auto mx-sm-0">
          <input class="form-check-input" type="checkbox" id="update-info-5">
          <label class="form-check-label fs-ms" for="update-info-5">Notify me when this product is updated</label>
        </div>
        <div class="d-flex align-items-center justify-content-center justify-content-sm-start pt-2">
          <div class="my-2">
            <button class="btn btn-primary btn-sm me-3" type="button"><i class="ci-download me-1"></i>Download</button>
