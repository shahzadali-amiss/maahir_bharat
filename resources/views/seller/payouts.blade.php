    ...
    <div class="row mx-n2 py-2">
      ...
      <div class="col-sm-6 px-2 mb-4">
        <div class="bg-secondary h-100 rounded-3 p-4">
          ...
          <div class="d-flex flex-wrap align-items-center py-1 mb-2"><img class="d-block mb-2 me-2" src="../img/marketplace/account/paypal-logo.png" width="100" alt="PayPal"><span class="fs-xs mb-2">john.doe@example.com</span></div><a class="btn btn-primary btn-sm" href="#">Change payout method</a>
        </div>
      </div>
    </div>
