    ...
    <div class="tab-content">
      ...
      <div class="tab-pane fade show active" id="profile" role="tabpanel">
        <div class="bg-secondary rounded-3 p-4 mb-4">
          <div class="d-flex align-items-center"><img class="rounded" src="../img/marketplace/account/avatar.png" width="90" alt="">
            <div class="ps-3">
        ...
        <div class="row gx-4 gy-3">
          ...
          <div class="col-sm-6">
            ...
            <input class="form-control" type="text" id="dashboard-profile-name" value="">
          </div>
          <div class="col-sm-6">
