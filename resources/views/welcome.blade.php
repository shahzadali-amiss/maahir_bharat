...
@section('content') 
    <div id="common-home">
        ...
        <div class="container">
            <div class="row">
                <aside id="column-left" class="col-sm-3 hidden-xs">
                    <div class="banner-outer html1 clearfix">
                        <div class="html1-inner">
                            <div class="banner1 banners">
                                <div class="inner1">
                                    <a href="#"><img src="{{asset('images/banner11.jpg')}}" alt="" class="img-responsive" /></a>
                                </div>
                                <div class="inner2">
                                    <div class="promo-text-box">
                                        <h4 class="promo-title">#Handmade Crafts</h4>
                            ...
                            <div id="slideshow0" class="swiper-container">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide text-center Main-banner1">
                                        <a href="#"><img src="image/cache/catalog/banners/mainbanner1-860x650.jpg" alt="Main-banner1" class="img-responsive" /></a>
                                    </div>
                                    <div class="swiper-slide text-center Main-banner2">
                                        <a href="#"><img src="image/cache/catalog/banners/mainbanner2-860x650.jpg" alt="Main-banner2" class="img-responsive" /></a>
                                    </div>
                                </div>
                            </div>
                ...
                <aside id="column-right" class="col-sm-3 hidden-xs">
                    <div class="banner-outer html2 clearfix">
                        <div class="html2-inner">
                            <div class="banner2 banners">
                                <div class="inner1">
                                    <a href="#"><img src="images/banner33.jpg" alt="" class="img-responsive" /></a>
                                </div>
                                <div class="inner2">
                                    <div class="promo-text-box">
                                        <h4 class="promo-title">#New Arrival</h4>
                                        <a href="#" class="btn button">Shop Now</a>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="container">
            <div class="banner-outer html4 clearfix mt-80">
                <div class="html4-inner">
                    <div class="promo-video-img">
                        <img src="images/banner1.jpg" alt="" class="img-responsive" />
                        <div class="content-block">
                            <div class="promo-video">
                                <a class="video-btn popup-youtube" href="#"><i class="fa fa-play"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="video-promo-desc">
                        <div class="content">
                            <h3 class="video-title">Welcome to Mahir Bharat</h3>
                            <p class="video-desc">
                                <b>Mahirbharat.com</b> is an online portal for finest Indian handicrafts. Our portal gives you an insight of rich Indian culture and its products. We deal with finest quality of handmade items.
                                We teamed up with the most skilled and amateur hand crafted designers from all over India and came to you.
                            </p>
                            <a href="{{ route('all-products') }}" class="btn button">Shop Now</a>
                            <a href="#" class="btn btn-navbar">More About</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <section id="collection_cities">   

                <div class="row">
                  <div class="col-md-12">
                    <center>
                        <h3 class="video-title">
                            Traditional and Antique collection
                        </h3>
                        <p class="video-desc">
        ...
        <div class="banner-outer html3 clearfix col-md-3 hidden-sm hidden-xs">
            <div class="html3-inner">
                <div class="banner3 banners">
                    <div class="inner1">
                        <a href="#"><img src="{{asset('images/decor.jpg')}}" alt="" class="img-responsive" /></a>
                    </div>
                    <div class="inner2">
                        <div class="promo-text-box">
                            <h4 class="promo-title">Decorative Vases</h4>
                            <div class="promo-desc">Get<span> 40% </span>off</div>
                        </div>
                    </div>
                </div> 
            </div>
        ...
        <div class="box all-products special col-md-9">
            <div class="box-heading"> 
                <div class="box-content">
                    <div class="page-title toggled"><h3>Tranding</h3></div>
        ...
        <div class="category-featured box mt-80">
            <div class="container box">
                <div class="row">
                    <div class="page-title toggled"><h3>Explore By Categories</h3></div>
                    <div class="category-box">
                        <div class="category-feature-list">
                            <div id="category-carousel" class="box-category category-carousel clearfix" data-items="3">
                              @foreach($grands as $g)
        ...
        <div class="service-box mt-80">
            <div class="container">
                <div class="row">
                    <div class="service-item col-xs-3 col-sm-3 service-itm">
                        <div class="service">
                    ...
                    <div class="service-item col-xs-3 col-sm-3 service-itm">
                        <div class="service">
                            ...
                            <div class="service-content">
                                ...
                                <span class="promo-desc">Cash On Delivery</span>
                            </div>
                        </div>
                    </div>
                    <div class="service-item col-xs-3 col-sm-3 service-itm">
        ...
        <!-- <div class="mblog section mt-50 clearfix">
                    ...
                    <div class="block_box row">
                        <div id="blogcarousel" class="blogs-block blog-carousel clearfix" data-items="2">
                            <div class="blog-block product-layout col-xs-12">
                                <div class="item">
                                    <div class="row">
                                        <div class="blog-info col-sm-5">
                                            <div class="image">
                                                <a href="index3c1a.html?route=mahardhi_blog/article&amp;article_id=1">
                                                    <img src="{{asset('image/cache/catalog/blogs/blog1-420x420.jpg')}}" alt="" title="Consectetur adipiscing" class="img-responsive" />
                                                </a>
                                                <div class="zoom-post">
                                                    <a class="hover-zoom" href="{{asset('image/cache/catalog/blogs/blog1-1394x1394.jpg')}}" data-lightbox="example-set" title="Consectetur adipiscing"></a>
                                                    <a class="hover-post" href="index3c1a.html?route=mahardhi_blog/article&amp;article_id=1"></a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="caption blog-description col-sm-7">
                                            <div class="link_info">
                                                <span class="block-date"><i class="fa fa-calendar-o"></i>05 December 2019</span>

                                                <span class="blog-comment"><i class="fa fa-comments-o"></i>2 Comments</span>

                                                <h4 class=""><a href="index3c1a.html?route=mahardhi_blog/article&amp;article_id=1">Consectetur adipiscing</a></h4>
                                                <div class="blog-text">
                                                    <span>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500...</span>
                                                </div>
                                                <a class="blog-read btn-default" onclick="location.href = ('index3c1a.html?route=mahardhi_blog/article&amp;article_id=1');" title="Read more">Read more</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="blog-block product-layout col-xs-12">
                                <div class="item">
                                    <div class="row">
                                        <div class="blog-info col-sm-5">
                                            <div class="image">
                                                <a href="index4593.html?route=mahardhi_blog/article&amp;article_id=3"><img src="{{asset('image/cache/catalog/blogs/blog3-420x420.jpg')}}" alt="" title="Lorem Ipsum Dolo" class="img-responsive" /></a>
                                                <div class="zoom-post">
                                                    <a class="hover-zoom" href="{{asset('image/cache/catalog/blogs/blog3-1394x1394.jpg')}}" data-lightbox="example-set" title="Lorem Ipsum Dolo"></a>
                                                    <a class="hover-post" href="index4593.html?route=mahardhi_blog/article&amp;article_id=3"></a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="caption blog-description col-sm-7">
                                            <div class="link_info">
                                                ...
                                                <h4 class=""><a href="index4593.html?route=mahardhi_blog/article&amp;article_id=3">Lorem Ipsum Dolo</a></h4>
                                                <div class="blog-text">
                                                    <span>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500...</span>
                                                </div>
                                                <a class="blog-read btn-default" onclick="location.href = ('index4593.html?route=mahardhi_blog/article&amp;article_id=3');" title="Read more">Read more</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="blog-block product-layout col-xs-12">
                                <div class="item">
                                    <div class="row">
                                        <div class="blog-info col-sm-5">
                                            <div class="image">
                                                <a href="index65a4.html?route=mahardhi_blog/article&amp;article_id=4">
                                                    <img src="{{asset('image/cache/catalog/blogs/blog4-420x420.jpg')}}" alt="" title="Nam nec rhoncus est " class="img-responsive" />
                                                </a>
                                                <div class="zoom-post">
                                                    <a class="hover-zoom" href="{{asset('image/cache/catalog/blogs/blog4-1394x1394.jpg')}}" data-lightbox="example-set" title="Nam nec rhoncus est "></a>
                                                    <a class="hover-post" href="index65a4.html?route=mahardhi_blog/article&amp;article_id=4"></a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="caption blog-description col-sm-7">
                                            <div class="link_info">
                                                ...
                                                <h4 class=""><a href="index65a4.html?route=mahardhi_blog/article&amp;article_id=4">Nam nec rhoncus est </a></h4>
                                                <div class="blog-text">
                                                    <span>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500...</span>
                                                </div>
                                                <a class="blog-read btn-default" onclick="location.href = ('index65a4.html?route=mahardhi_blog/article&amp;article_id=4');" title="Read more">Read more</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="blog-block product-layout col-xs-12">
                                <div class="item">
                                    <div class="row">
                                        <div class="blog-info col-sm-5">
                                            <div class="image">
                                                <a href="index6cf8.html?route=mahardhi_blog/article&amp;article_id=5">
                                                    <img src="{{asset('image/cache/catalog/blogs/blog5-420x420.jpg')}}" alt="" title="Duis pulvinar augue nisi" class="img-responsive" />
                                                </a>
                                                <div class="zoom-post">
                                                    <a class="hover-zoom" href="{{asset('image/cache/catalog/blogs/blog5-1394x1394.jpg')}}" data-lightbox="example-set" title="Duis pulvinar augue nisi"></a>
                                                    <a class="hover-post" href="index6cf8.html?route=mahardhi_blog/article&amp;article_id=5"></a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="caption blog-description col-sm-7">
                                            <div class="link_info">
                                                <span class="block-date"><i class="fa fa-calendar-o"></i>12 March 2021</span>

                                                <span class="blog-comment"><i class="fa fa-comments-o"></i>0 Comments</span>

                                                <h4 class=""><a href="index6cf8.html?route=mahardhi_blog/article&amp;article_id=5">Duis pulvinar augue nisi</a></h4>
                                                <div class="blog-text">
                                                    <span>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500...</span>
                                                </div>
                                                <a class="blog-read btn-default" onclick="location.href = ('index6cf8.html?route=mahardhi_blog/article&amp;article_id=5');" title="Read more">Read more</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="blog-block product-layout col-xs-12">
                                <div class="item">
                                    <div class="row">
                                        <div class="blog-info col-sm-5">
                                            <div class="image">
                                                <a href="indexed83.html?route=mahardhi_blog/article&amp;article_id=2">
                                                    <img src="{{asset('image/cache/catalog/blogs/blog2-420x420.jpg')}}" alt="" title="The standard Lorem Ipsum" class="img-responsive" />
                                                </a>
                                                <div class="zoom-post">
                                                    <a class="hover-zoom" href="{{asset('image/cache/catalog/blogs/blog2-1394x1394.jpg')}}" data-lightbox="example-set" title="The standard Lorem Ipsum"></a>
                                                    <a class="hover-post" href="indexed83.html?route=mahardhi_blog/article&amp;article_id=2"></a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="caption blog-description col-sm-7">
                                            <div class="link_info">
                                                ...
                                                <h4 class=""><a href="indexed83.html?route=mahardhi_blog/article&amp;article_id=2">The standard Lorem Ipsum</a></h4>
                                                <div class="blog-text">
                                                    <span>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500...</span>
                                                </div>
                                                <a class="blog-read btn-default" onclick="location.href = ('indexed83.html?route=mahardhi_blog/article&amp;article_id=2');" title="Read more">Read more</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="box carousel brand mt-80">
            <div class="container">
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide col-sm-12">
                                <div class="text-center">
                                    <img src="{{asset('image/cache/catalog/manufactures/1-76x40.png')}}" alt="Starbucks" class="img-responsive m-auto" />
                                </div>
                            </div>
                            <div class="swiper-slide col-sm-12">
                                <div class="text-center">
                                    <img src="{{asset('image/cache/catalog/manufactures/2-76x40.png')}}" alt="Disney" class="img-responsive m-auto" />
                                </div>
                            </div>
                            <div class="swiper-slide col-sm-12">
                                <div class="text-center">
                                    <img src="{{asset('image/cache/catalog/manufactures/3-76x40.png')}}" alt="Dell" class="img-responsive m-auto" />
                                </div>
                            </div>
                            <div class="swiper-slide col-sm-12">
                                <div class="text-center">
                                    <img src="{{asset('image/cache/catalog/manufactures/4-76x40.png')}}" alt="Harley Davidson" class="img-responsive m-auto" />
                                </div>
                            </div>
                            <div class="swiper-slide col-sm-12">
                                <div class="text-center">
                                    <img src="{{asset('image/cache/catalog/manufactures/5-76x40.png')}}" alt="Canon" class="img-responsive m-auto" />
                                </div>
                            </div>
                            <div class="swiper-slide col-sm-12">
                                <div class="text-center">
                                    <img src="{{asset('image/cache/catalog/manufactures/6-76x40.png')}}" alt="Burger King" class="img-responsive m-auto" />
                                </div>
                            </div>
                            <div class="swiper-slide col-sm-12">
                                <div class="text-center">
                                    <img src="{{asset('image/cache/catalog/manufactures/7-76x40.png')}}" alt="Coca Cola" class="img-responsive m-auto" />
                                </div>
                            </div>
                            <div class="swiper-slide col-sm-12">
                                <div class="text-center">
                                    <img src="{{asset('image/cache/catalog/manufactures/8-76x40.png')}}" alt="Coca Cola" class="img-responsive m-auto" />
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="newsletter-wrap clearfix">
                            <div class="newsletter-content">
                                <div class="newsletter-content-innner">
                                    <h3>Subscribe our MAHIR BHARAT</h3>
                                    <p class="hidden">subscribe to our email MAHIR BHARAT today to receive update on the latest news</p>
                                    <form name="frmnewsletterpopup" id="frmnewsletterpopup" onsubmit="subscribe_popup();return false" method="post">
                                        <input type="email" class="newsletter_usr_popup_email" name="newsletter_usr_popup_email" id="newsletter_usr_popup_email" placeholder="Enter your email..." required />
...
@push('styles')
<style type="text/css">
    .category-box .owl-carousel .owl-item img {
        max-height: 450px;
        object-fit: cover;
    }
