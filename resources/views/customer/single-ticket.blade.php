...
<section class="col-lg-8">
  ...
  <div class="d-none d-lg-flex justify-content-between align-items-center pt-lg-3 pb-4 pb-lg-5 mb-lg-4">
    ...
    </div><a class="btn btn-primary btn-sm" href="account-signin.html"><i class="ci-sign-out me-2"></i>Sign out</a>
  </div>
  ...
  <!-- Comment-->
  <div class="d-flex align-items-start pb-4 border-bottom"><img class="rounded-circle" src="{{asset('img/testimonials/03.jpg')}}" width="50" alt="Michael Davis">
    <div class="ps-3">
  ...
  <!-- Comment reply-->
  <div class="d-flex align-items-start py-4 border-bottom"><img class="rounded-circle" src="{{asset('img/testimonials/03.jpg')}}" width="50" alt="Michael Davis">
    <div class="ps-3">
      <h6 class="fs-md mb-2">Michael Davis</h6>
      ...
      <!-- Comment-->
      <div class="d-flex align-items-start border-top pt-4 mt-4"><img class="rounded-circle" src="{{asset('img/testimonials/04.jpg')}}" width="50" alt="Susan Gardner">
        <div class="ps-3">
