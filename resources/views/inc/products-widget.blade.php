        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 mb-2 py-3">
            <div class="widget">
              ...
              <div class="d-flex align-items-center pb-2 border-bottom"><a class="d-block" href="shop-single-v1.html"><img src="{{asset('img/shop/cart/widget/01.jpg')}}" width="64" alt="Product"></a>
                <div class="ps-2">
              ...
              <div class="d-flex align-items-center py-2 border-bottom"><a class="d-block" href="shop-single-v1.html"><img src="{{asset('img/shop/cart/widget/02.jpg')}}" width="64" alt="Product"></a>
                <div class="ps-2">
              ...
              <div class="d-flex align-items-center py-2 border-bottom"><a class="d-block" href="shop-single-v1.html"><img src="{{asset('img/shop/cart/widget/03.jpg')}}" width="64" alt="Product"></a>
                <div class="ps-2">
              ...
              <div class="d-flex align-items-center py-2"><a class="d-block" href="shop-single-v1.html"><img src="{{asset('img/shop/cart/widget/04.jpg')}}" width="64" alt="Product"></a>
                <div class="ps-2">
          ...
          <div class="col-lg-4 col-md-6 mb-2 py-3">
            <div class="widget">
              ...
              <div class="d-flex align-items-center pb-2 border-bottom"><a class="d-block" href="shop-single-v1.html"><img src="{{asset('img/shop/widget/02.jpg')}}" width="64" alt="Product"></a>
                <div class="ps-2">
              ...
              <div class="d-flex align-items-center py-2 border-bottom"><a class="d-block" href="shop-single-v1.html"><img src="{{asset('img/shop/widget/01.jpg')}}" width="64" alt="Product"></a>
                <div class="ps-2">
              ...
              <div class="d-flex align-items-center py-2 border-bottom"><a class="d-block" href="shop-single-v1.html"><img src="{{asset('img/shop/widget/03.jpg')}}" width="64" alt="Product"></a>
                <div class="ps-2">
              ...
              <div class="d-flex align-items-center py-2"><a class="d-block" href="shop-single-v1.html"><img src="{{asset('img/shop/widget/04.jpg')}}" width="64" alt="Product"></a>
                <div class="ps-2">
          ...
          <div class="col-md-4 col-sm-6 d-none d-lg-block"><a class="d-block" href="shop-grid-ls.html"><img class="d-block rounded-3" src="{{asset('img/home/banners/v-banner.jpg')}}" alt="Promo banner"></a></div>
        </div>
      </section>