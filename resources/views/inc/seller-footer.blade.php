      ...
      <div class="container pt-2 pb-3">
        <div class="row">
          <div class="col-md-6 text-center text-md-start mb-4">
            <div class="text-nowrap mb-3"><a class="d-inline-block align-middle mt-n2 me-2" href="#">
              <h5 style="color: white">MAHIR BHARAT</h5>
              <!-- <img class="d-block" src="{{asset('img/footer-logo-light.png')}}" width="117" alt="Cartzilla"> --></a><span class="d-inline-block align-middle h5 fw-light text-white mb-0">Marketplace</span></div>
      ...
      <div class="pt-5 bg-darker">
        <div class="container">
          ...
          <div class="d-md-flex justify-content-between pt-4">
            <div class="pb-4 fs-xs text-light opacity-50 text-center text-md-start">MaahirBharat © All rights reserved.</div>
            <div class="widget widget-links widget-light pb-4">
              <ul class="widget-list d-flex flex-wrap justify-content-center justify-content-md-start">
                <li class="widget-list-item ms-4"><a class="widget-list-link fs-ms" href="{{ route('guest-home') }}">Home</a></li>
                <li class="widget-list-item ms-4"><a class="widget-list-link fs-ms" href="{{ route('policy', 'shipping') }}">Shipping Policy</a></li>
                <li class="widget-list-item ms-4"><a class="widget-list-link fs-ms" href="{{ route('policy', 'returns') }}">Return & Refund Policy</a></li>
                <li class="widget-list-item ms-4"><a class="widget-list-link fs-ms" href="{{ route('policy', 'supplier') }}">Supplier Policy</a></li>
                <li class="widget-list-item ms-4"><a class="widget-list-link fs-ms" href="{{ route('policy', 'buyer') }}">Buyer Policy</a></li>
              </ul>
            </div>
          </div>
        </div>
    ...
    <script src="{{ asset('vendor/smooth-scroll/dist/smooth-scroll.polyfills.min.js') }}" crossorigin="anonymous"></script>
    <!-- Main theme script-->
    @stack('scripts')
    <script src="{{asset('js/theme.min.js')}}"></script>
    <script src="{{asset('js/main.js')}}"></script>
    <script type="text/javascript">
      // var api_andpoint = window.origin+""
    </script>
  </body>
</html>