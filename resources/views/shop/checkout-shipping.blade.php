    ...
    <div class="row">
      <section class="col-lg-8">
        ...
        @include('inc.session-message')
          <h2 class="h6 pb-3 mb-2">Current Shipping Address</h2>
          <table class="w-100">
            <tr>
              <th>Name</th>
        ...
        <div class="d-none d-lg-flex pt-4">
          <div class="w-50 pe-3"><a class="btn btn-secondary d-block w-100" href="{{route('checkout-details')}}"><i class="ci-arrow-left mt-sm-0 me-1"></i><span class="d-none d-sm-inline">Back to Details</span><span class="d-inline d-sm-none">Back</span></a></div>
          <div class="w-50 ps-2"><a class="btn btn-primary d-block w-100" href="{{route('checkout-review')}}"><span class="d-none d-sm-inline">Review your order</span><span class="d-inline d-sm-none">Next</span><i class="ci-arrow-right mt-sm-0 ms-1"></i></a></div>
        </div>
      </section>
      <!-- Sidebar-->
            ...
            <div class="widget mb-3">
              ...
              <div class="d-flex align-items-center pb-2 border-bottom"><a class="d-block flex-shrink-0" href="{{route('single', $product->id)}}"><img src="{{ asset('product_images').'/'.$product->image }}" width="64" alt="Product"></a>
                <div class="ps-2">
                  ...
                  <div class="widget-product-meta"><span class="text-accent me-2">₹{{$product->offer_price}}</span><span class="text-muted">x {{getCartProductQuantity($product->id)}}</span></div>
                </div>
              </div>
              @endforeach
            </div>
