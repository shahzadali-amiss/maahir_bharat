...
<div class="bg-dark py-5">
      ...
      <div class="container pb-5 mb-2 mb-md-4">
       <!-- Toolbar-->
        ...
        {{--<div class="row pt-3 mx-n2">
          ...
          <div class="col-lg-3 col-md-4 col-sm-6 px-2 mb-4">
            <div class="card product-card">
              <button class="btn-wishlist btn-sm" type="button" data-bs-toggle="tooltip" data-bs-placement="left" title="Add to wishlist"><i class="ci-heart"></i></button><a class="card-img-top d-block overflow-hidden" href="shop-single-v1.html"><img src="{{asset('img/shop/catalog/01.jpg')}}" alt="Product"></a>
          ...
          <div class="col-lg-3 col-md-4 col-sm-6 px-2 mb-4">
            <div class="card product-card"><span class="badge bg-danger badge-shadow">Sale</span>
              <button class="btn-wishlist btn-sm" type="button" data-bs-toggle="tooltip" data-bs-placement="left" title="Add to wishlist"><i class="ci-heart"></i></button><a class="card-img-top d-block overflow-hidden" href="shop-single-v1.html"><img src="{{asset('img/shop/catalog/02.jpg')}}" alt="Product"></a>
          ...
          <div class="col-lg-3 col-md-4 col-sm-6 px-2 mb-4">
            <div class="card product-card">
              <button class="btn-wishlist btn-sm" type="button" data-bs-toggle="tooltip" data-bs-placement="left" title="Add to wishlist"><i class="ci-heart"></i></button><a class="card-img-top d-block overflow-hidden" href="shop-single-v1.html"><img src="{{asset('img/shop/catalog/03.jpg')}}" alt="Product"></a>
          ...
          <div class="col-lg-3 col-md-4 col-sm-6 px-2 mb-4">
            <div class="card product-card">
              <button class="btn-wishlist btn-sm" type="button" data-bs-toggle="tooltip" data-bs-placement="left" title="Add to wishlist"><i class="ci-heart"></i></button><a class="card-img-top d-block overflow-hidden" href="shop-single-v1.html"><img src="{{asset('img/shop/catalog/04.jpg')}}" alt="Product"></a>
          ...
          <div class="col-lg-3 col-md-4 col-sm-6 px-2 mb-4">
            <div class="card product-card">
              <button class="btn-wishlist btn-sm" type="button" data-bs-toggle="tooltip" data-bs-placement="left" title="Add to wishlist"><i class="ci-heart"></i></button><a class="card-img-top d-block overflow-hidden" href="shop-single-v1.html"><img src="{{asset('img/shop/catalog/05.jpg')}}" alt="Product"></a>
          ...
          <div class="col-lg-3 col-md-4 col-sm-6 px-2 mb-4">
            <div class="card product-card">
              <button class="btn-wishlist btn-sm" type="button" data-bs-toggle="tooltip" data-bs-placement="left" title="Add to wishlist"><i class="ci-heart"></i></button><a class="card-img-top d-block overflow-hidden" href="shop-single-v1.html"><img src="{{asset('img/shop/catalog/06.jpg')}}" alt="Product"></a>
          ...
          <div class="col-lg-3 col-md-4 col-sm-6 px-2 mb-4">
            <div class="card product-card">
              <button class="btn-wishlist btn-sm" type="button" data-bs-toggle="tooltip" data-bs-placement="left" title="Add to wishlist"><i class="ci-heart"></i></button><a class="card-img-top d-block overflow-hidden" href="shop-single-v1.html"><img src="{{asset('img/shop/catalog/07.jpg')}}" alt="Product"></a>
          ...
          <div class="col-lg-3 col-md-4 col-sm-6 px-2 mb-4">
            <div class="card product-card">
              <button class="btn-wishlist btn-sm" type="button" data-bs-toggle="tooltip" data-bs-placement="left" title="Add to wishlist"><i class="ci-heart"></i></button><a class="card-img-top d-block overflow-hidden" href="shop-single-v1.html"><img src="{{asset('img/shop/catalog/08.jpg')}}" alt="Product"></a>
          ...
          <div class="col-lg-3 col-md-4 col-sm-6 px-2 mb-4">
            <div class="card product-card">
              <button class="btn-wishlist btn-sm" type="button" data-bs-toggle="tooltip" data-bs-placement="left" title="Add to wishlist"><i class="ci-heart"></i></button><a class="card-img-top d-block overflow-hidden" href="shop-single-v1.html"><img src="{{asset('img/shop/catalog/09.jpg')}}" alt="Product"></a>
          ...
          <div class="col-lg-3 col-md-4 col-sm-6 px-2 mb-4">
            <div class="card product-card">
              <button class="btn-wishlist btn-sm" type="button" data-bs-toggle="tooltip" data-bs-placement="left" title="Add to wishlist"><i class="ci-heart"></i></button><a class="card-img-top d-block overflow-hidden" href="shop-single-v1.html"><img src="{{asset('img/shop/catalog/10.jpg')}}" alt="Product"></a>
          ...
          <div class="col-lg-3 col-md-4 col-sm-6 px-2 mb-4">
            <div class="card product-card">
              <button class="btn-wishlist btn-sm" type="button" data-bs-toggle="tooltip" data-bs-placement="left" title="Add to wishlist"><i class="ci-heart"></i></button><a class="card-img-top d-block overflow-hidden" href="shop-single-v1.html"><img src="{{asset('img/shop/catalog/11.jpg')}}" alt="Product"></a>
          ...
          <div class="col-lg-3 col-md-4 col-sm-6 px-2 mb-4">
            <div class="card product-card">
              <button class="btn-wishlist btn-sm" type="button" data-bs-toggle="tooltip" data-bs-placement="left" title="Add to wishlist"><i class="ci-heart"></i></button><a class="card-img-top d-block overflow-hidden" href="shop-single-v1.html"><img src="{{asset('img/shop/catalog/12.jpg')}}" alt="Product"></a>
          ...
          <div class="col-lg-3 col-md-4 col-sm-6 px-2 mb-4">
            <div class="card product-card"><span class="badge bg-danger badge-shadow">Sale</span>
              <button class="btn-wishlist btn-sm" type="button" data-bs-toggle="tooltip" data-bs-placement="left" title="Add to wishlist"><i class="ci-heart"></i></button><a class="card-img-top d-block overflow-hidden" href="shop-single-v1.html"><img src="{{asset('img/shop/catalog/13.jpg')}}" alt="Product"></a>
          ...
          <div class="col-lg-3 col-md-4 col-sm-6 px-2 mb-4">
            <div class="card product-card">
              <button class="btn-wishlist btn-sm" type="button" data-bs-toggle="tooltip" data-bs-placement="left" title="Add to wishlist"><i class="ci-heart"></i></button><a class="card-img-top d-block overflow-hidden" href="shop-single-v1.html"><img src="{{asset('img/shop/catalog/14.jpg')}}" alt="Product"></a>
          ...
          <div class="col-lg-3 col-md-4 col-sm-6 px-2 mb-4">
            <div class="card product-card">
              <button class="btn-wishlist btn-sm" type="button" data-bs-toggle="tooltip" data-bs-placement="left" title="Add to wishlist"><i class="ci-heart"></i></button><a class="card-img-top d-block overflow-hidden" href="shop-single-v1.html"><img src="{{asset('img/shop/catalog/15.jpg')}}" alt="Product"></a>
          ...
          <div class="col-lg-3 col-md-4 col-sm-6 px-2 mb-4">
            <div class="card product-card">
              <button class="btn-wishlist btn-sm" type="button" data-bs-toggle="tooltip" data-bs-placement="left" title="Add to wishlist"><i class="ci-heart"></i></button><a class="card-img-top d-block overflow-hidden" href="shop-single-v1.html"><img src="{{asset('img/shop/catalog/16.jpg')}}" alt="Product"></a>
        ...
        @if($products->isEmpty())
          <h3 class="text-center mt-5"><i class="far fa-frown"></i>No Products Found</h3>
        @else
        ...
        <div class="row pt-3 mx-n2">
          ...
          {{--<div class="col-lg-3 col-md-4 col-sm-6 px-2 mb-4">
            <div class="card product-card">
              ...
              <div class="card-body py-2">
                <a class="product-meta d-block fs-xs pb-1" href="{{ route('products', [$p->grand_category_id, $p->parent_category_id, $p->category_id]) }}">
                ...
                <h3 class="product-title fs-sm"><a href="{{ route('single', $p->id) }}">{{ ucwords($p->name) }}</a></h3>
                <div class="d-flex justify-content-between">
              ...
              <div class="card-body">
                ...
                <a class="btn btn-primary btn-sm d-block w-100 mb-2" href="#"><i class="ci-cart fs-sm me-1"></i>Add to Cart</a>
                <!-- <div class="text-center"><a class="nav-link-style fs-ms" href="#quick-view" data-bs-toggle="modal"><i class="ci-eye align-middle me-1"></i>Quick view</a></div> -->
              </div>
            </div>
            <hr class="d-sm-none">
          ...
          <div class="col-lg-3 col-md-4 col-sm-6 px-2 mb-5">
            <div class="card product-card card-static p-3">
              ...
              <div class="product-card-content">
                <div class="card-body py-2">
                  ...
                  <div class="d-flex justify-content-between">
                    <div class="product-price">
                      <del class="text-muted">&#x20B9; {{ucwords($p->mrp)}}.
                      </del><br>
                      <span class="text-accent">&#x20B9; {{ucwords($p->offer_price)}}.
                      </span>
                    </div>
                ...
                <div class="row justify-content-around product-call-to-action">
                  @php
                  {{ $is_in_cart=false; }}
                  @endphp
                  ...
                  @endforeach
                  @if($is_in_cart)
                    <a class="col-12 btn btn-secondary btn-sm" href="{{route('single', $p->id)}}">
                      <small>View details</small>
                    </a>
                  @else
                    <form class="col-5 px-0" action="{{ route('addtocart') }}" method="POST">
                      @csrf
                      <input type="hidden" name="product_id" value="{{ $p->id }}">
                      <input type="hidden" name="quantity" value="1">
                      @foreach(getProductAttributes($p->id) as $key => $value)
                    ...
                    <a class="col-5 btn btn-secondary btn-sm" href="{{route('single', $p->id)}}"><small>View details</small>
                    </a>
                  @endif
                </div>
              </div>
          ...
          <div class="row py-sm-2 m-auto">
            ...
            <div class="col-md-4 mt-4">
              <div class="d-flex flex-column h-100 bg-size-cover bg-position-center rounded-3 pt-4" style="background-image: url({{ asset('img/blog/banner-bg.jpg') }});">
